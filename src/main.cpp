...
uint256 hashGenesisBlock("0x9813ced97370561e7808aa2b010399f40f8bce91501161aa3488c5aa4e61926a");
...
const string strMessageMagic = "SyariahCoin01 Signed Message:\n";
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // SyariahCoin01: 0.35 days
static const int64 nTargetSpacing = 15; // SyariahCoin01: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal SyariahCoin01 miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SyariahCoin01", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// Genesis block:
	/*
	block.nTime = 1522317522 
	block.nNonce = 2087034637 
	block.GetHash = 9813ced97370561e7808aa2b010399f40f8bce91501161aa3488c5aa4e61926a
